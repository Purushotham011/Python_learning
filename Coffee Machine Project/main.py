...
def is_resource_sufficient(order_ingre ):
    """Returns true when order can be made, false if ingredient are"""
...
def is_ts(money_received, drink_cost):
...
while is_on:
    ...
    if choice == "off":
        ...
        if is_resource_sufficient(drink["ingredients"]):
            ...
            is_ts(payment, drink["cost"])
            if is_ts(payment, drink["cost"]):
